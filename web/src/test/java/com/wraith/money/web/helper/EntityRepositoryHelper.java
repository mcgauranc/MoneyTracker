...
public class EntityRepositoryHelper {
     ...
     *
     * @param entityURI The entity location.
     ...
     * @throws Exception
     */
    public String createUser(String userName, String password, String firstName, String lastName) throws Exception {
        Map<String, String> parameters = new HashMap<>();
     ...
     * @param city        The addresses city.
     * @param county      The addresses county.
     * @param countryName The addresses country.
...
//        associateEntities(transactionLocation.concat("/").concat("payee"), payeeLocation);
    ...
    public String entityRecordExists(String entity, String method, Map<String, String> parameters) throws Exception {
        ...
        MockHttpServletResponse response = requestHelper.performGetRequest("/api/".concat(entity).concat("/").concat("search").concat("/").concat(method), parameters);
