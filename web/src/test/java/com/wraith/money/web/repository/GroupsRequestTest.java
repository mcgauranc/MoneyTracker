...
public class GroupsRequestTest extends AbstractBaseIntegrationTests {
    ...
    public void testCreateGroupsRequest() throws Exception {
        ...
        String resourceRequest = createNewGroup("Developers", AuthorityRequestTest.getNewAuthoritySet("ROLE_DEVELOPER", "ROLE_REPORTER"));
    ...
    public void testUpdateGroupsRequest() throws Exception {
        ...
        String resourceRequest = createNewGroup("Testers", AuthorityRequestTest.getNewAuthoritySet("ROLE_TESTER"));
    ...
    public void testUpdateGroupsWithOrdinaryUserRequest() throws Exception {
        ...
        String resourceRequest = createNewGroup("Marketing", AuthorityRequestTest.getNewAuthoritySet("ROLE_MARKETING"));
    ...
    public void testDeleteCategoryWithAdminUserRequest() throws Exception {
        authenticate("Admin", "Passw0rd");
        String resourceRequest = createNewGroup("Publishers", AuthorityRequestTest.getNewAuthoritySet("ROLE_PUBLISHERS"));
    ...
    public void testDeleteCategoryWithNoParentForCurrentUserRequest() throws Exception {
        ...
        String resourceRequest = createNewGroup("Editors", AuthorityRequestTest.getNewAuthoritySet("ROLE_EDITORS"));
