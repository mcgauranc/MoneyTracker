...
public class TransactionRequestTests extends AbstractBaseIntegrationTests {
	 ...
	 * @throws Exception
	 */
	public static Transaction getNewTransaction(Account account, Double amount, Category category, String chequeNumber,
			Currency currency, String notes, Payee payee, Integer quantity, Users user) {
	...
	public void testCreatePayeeWithNoAuthenticationRequest() throws Exception {
		authenticate("", "");
		String resourceLocation = createNewTransaction("Current", 12.65, "Toothpaste", "12345", "Euro", "EUR",
	...
	public void testCreateTransactionWithAdminUser() throws Exception {
		...
		String resourceLocation = createNewTransaction("Credit Card", 12.65, "Toothpaste", "12345", "Euro", "EUR",
				"This is the note", "Superquinn", 1, "Administrator");
	...
	public void testUpdateTransactionWithAdminUser() throws Exception {
		...
		String resourceLocation = createNewTransaction("Wallet", 65.54, "Chocolate", "", "Euro", "EUR",
	...
	public void testUpdateTransactionWithNormalUser() throws Exception {
		...
		String resourceLocation = createNewTransaction("Wallet", 12.54, "Beer", "", "Euro", "EUR", "This is a six pack", "Spar",
	...
	public void testDeleteTransactionWithNormalUser() throws Exception {
		...
		String resourceLocation = createNewTransaction("Wallet", 50.00, "Money Found", "", "Euro", "EUR",
	 ...
	 * @throws Exception
	 */
	private String createNewTransaction(String accountName, Double amount, String categoryName, String chequeNumber,
			String currencyName, String currencyISO, String notes, String payeeName, Integer quantity, String userName)
			throws Exception {
		Users user = getUser(userName);
		Account account = getAccount(accountName, 1234.56, "Euro", "EUR");
		Category category = getCategory(categoryName);
		Currency currency = getCurrency(currencyName, currencyISO);
		Payee payee = getPayee(payeeName);

		Transaction transaction = getNewTransaction(account, amount, category, chequeNumber, currency, notes, payee, quantity,
				user);
	 ...
	 * @param currencyISO
	 *            The currency ISO for the account.
	 * @param currencyName
	 *            The name of the currency for the account.
	 * @return An instance of the found or created account.
	 */
	private Account getAccount(String accountName, Double accountBalance, String currencyName, String currencyISO) {
		if (accountRepository.findByName(accountName).size() == 0) {
			...
			Account account = AccountRequestTest.getNewAccount(accountName, accountBalance);
