...
public class EncodingTest {
    ...
    public void testEncodePasswordWithNullSalt() throws Exception {
        ...
        String encodedPassword = encoding.encodePassword("Passw0rd", null);
    ...
    public void testEncodePasswordWithStringSalt() throws Exception {
        Encoding encoding = new Encoding();
        String encodedPassword = encoding.encodePassword("Passw0rd", "123456");
    ...
    public void testValidPasswordWithNullSalt() throws Exception {
        Encoding encoding = new Encoding();
        Assert.assertTrue(encoding.validPassword("Passw0rd", "d41e98d1eafa6d6011d3a70f1a5b92f0", null));
    }

    @Test
    public void testValidPasswordWithStringSalt() throws Exception {
        Encoding encoding = new Encoding();
        Assert.assertTrue(encoding.validPassword("Passw0rd", "f7ceac87f089e9185cf0313f1ef43f60", "123456"));
    }
}
